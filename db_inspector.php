...
<head>
    <meta charset="UTF-8">
    <title>DB Inspector - Blood Bank Management</title>
...
<body>
    <h1>Database Inspector - Blood Bank Management</h1>
    <p>
        <a href="index.php" class="btn">← Back to Donor List</a>
    </p>
    ...
    <div class="console">
        ...
        <form method="POST">
            <textarea name="sql" placeholder="e.g. SELECT * FROM donors LIMIT 5"><?= htmlspecialchars($querySQL) ?></textarea>
    ...
    <p style="margin-top:20px;"><a href="index.php">← Back to Donor List</a></p>
</body>
</html>